...
UI.AddTab("AgeplayPlayground", function(tab)
    ...
    sec:Button("Apply", function()
        ...
        savedValue = setVal
        updateLabel()
        notify("Passive Agility set to " .. tostring(setVal), "Agility", 120)
    end)
    sec:Spacing()
    sec:Button("Increase +10")
    kb_up = sec:Keybind("agility_increase_kb", 0x58, "click")
    sec:Button("Decrease -10")
    kb_down = sec:Keybind("agility_decrease_kb", 0x12, "click")
    sec:Spacing()
    ...
    kb_esp = esp:Keybind("esp_kb", 0x06, "click")
    esp:Spacing()
